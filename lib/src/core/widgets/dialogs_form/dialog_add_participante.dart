            ...
            child: SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  CustomTextFormFieldRectangular(controller: controller, hintText: 'Nome do Participante'),
                  const SizedBox(height: 8),
                  CustomTextFormFieldRectangular(controller: controller, hintText: 'Email do Participante'),
                  const SizedBox(height: 8),
                  Row(
                    children: [CustomButton(onPressed: () {}, text: 'Add participante', height: 30)],
                  ),
                ],
              ),
            ),
